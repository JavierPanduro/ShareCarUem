...
/**
 * Created by Javier on 02/03/2017.
 */
...
public class ReservasAdapter extends BaseAdapter {
    ...
    public ReservasAdapter(Context context, ArrayList<Viaje> viaje) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ReservasAdapter.ViewHolder holder;

        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_viaje, null);

            holder = new ReservasAdapter.ViewHolder();
            ...
            holder = (ReservasAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.etDescripcion.setText("Plazas Reservadas: " + viaje.get(position).getPlazasreservadas());
